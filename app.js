function setUserDetails(mobileNumber) {
  ...
  fetch(`https://banking-9ki8.onrender.com/user/getByMobile?number=${mobileNumber}`, {
    method: "GET",
    credentials: "include",
     headers: {
...
fetch(`https://banking-9ki8.onrender.com/user/getByAccount?accountNumber=${accountNumber}`, {
    method: "GET",  
  headers: {
        "Authorization": `Bearer ${token}`
    }
...
function depositBalanceToUser(amount, pin) {
  ...
  const userData = JSON.parse(localStorage.getItem("userData"));
  fetch(
    `https://banking-9ki8.onrender.com/user/depositUsingPin?accountNumber=${userData.accountNumber}&ammount=${amount}&pin=${pin}`,
    {
      method: "PATCH",
      credentials: "include",
       headers: {
...
function withdrawBalanceFromUser(amount, pin) {
  ...
  const userData = JSON.parse(localStorage.getItem("userData"));
  fetch(
    `https://banking-9ki8.onrender.com/user/withdraw?accountNumber=${userData.accountNumber}&ammount=${amount}&pin=${pin}`,
    {
      method: "PATCH",
      credentials: "include",
       headers: {
...
function withdrawBalanceFromUser(accountNumber, amount, pin) {
  ...
  fetch(
    `https://banking-9ki8.onrender.com/user/withdraw?accountNumber=${accountNumber}&ammount=${amount}&pin=${pin}`,
    {
      method: "PATCH",
      credentials: "include",
       headers: {
...
function transectionsList() {
  ...
  const userData = JSON.parse(localStorage.getItem("userData"));
  fetch(
    `https://banking-9ki8.onrender.com/user/transection?number=${userData.accountNumber}`,
    {
      method: "GET",
      credentials: "include",
       headers: {
...
function recentTransectionSet() {
  ...
  const token=localStorage.getItem("jwtToken");
  fetch(
    `https://banking-9ki8.onrender.com/user/transection3?number=${userData.accountNumber}`,
    {
      method: "GET",
      credentials: "include",
       headers: {
...
function transferToAnother(receiverAccount, amount, description, PIN) {
  ...
  const userData = JSON.parse(localStorage.getItem("userData"));
    const token=localStorage.getItem("jwtToken");
  fetch(
    `https://banking-9ki8.onrender.com/user/transfer?accountNumber=${userData.accountNumber}&amount=${amount}&pin=${PIN}&receverAccount=${receiverAccount}&description=${description}`,
    {
      method: "PATCH",
      credentials: "include",
       headers: {
...
function setLoginStatus(account)
{
   ...
   fetch(`https://banking-9ki8.onrender.com/user/setLoginStatus?accountNumber=${account}`,
            {
              method: "PATCH",
              credentials: "include",
               headers: {
